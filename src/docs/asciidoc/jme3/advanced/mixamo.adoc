...
You can see a similar video demonstration of the process in the wiki <<jme3#animations-and-scenes#,Animations And Scenes>> under the CadNav → Mixamo → JME Workflow heading.
