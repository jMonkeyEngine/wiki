...
*  <<sdk/blender#,轉換Blender模型到JME3(.J3o檔)>>
...
*  link:http://www.youtube.com/watch?v=IDHMWsu_PqA[影片:在Blender創造世界實例]
...
重新設定一個Control, 呼叫 control.clearChannels();
