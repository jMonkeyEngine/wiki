...
Previous: <<hello_animation#,Hello Animation>>,
Next: <<hello_collision#,Hello Collision>>
...
image::beginner-picking.png[beginner-picking.png,with="",height="",align="center"]
...
Now, wouldn't it be nice if those targets and the floor were solid objects and you could walk around between them? Let's continue to learn about <<hello_collision#,Collision Detection>>.
