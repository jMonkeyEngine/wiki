...
Previous: <<hello_collision#,Hello Collision>>,
Next: <<hello_audio#,Hello Audio>>
...
<<sdk/terrain_editor#,TerrainEditor plugin>><<sdk/terrain_editor#,TerrainEditor plugin>>
...
Can you combine what you learned here and in <<hello_collision#,Hello Collision>>, and <<jme3/advanced/terrain_collision#,make the terrain solid>>?
...
Do you want to hear your players say “ouch! when they bump into a wall or fall off a hill? Continue with learning <<hello_audio#,how to add sound>> to your game.
