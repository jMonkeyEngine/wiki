= jMonkeyEngine 3 教學(7) - 哈囉 動畫(Animation)
:author:
:revnumber:
...
另參見: link:https://docs.google.com/leaf?id=0B9hhZie2D-fEYmRkMTYwN2YtMzQ0My00NTM4LThhOTYtZTk1MTRlYTNjYTc3&hl=en[在Blender中創造 動畫的OgreXML 模型]
