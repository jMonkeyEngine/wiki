...
link:http://www.youtube.com/watch?v=dXGfecvI1Sk[Youtube 影片]

image:jme3/beginner/chasecamera.png[chasecamera.png,width="",height=""]

*  link:https://code.google.com/p/jmonkeyengine/source/browse/#svn%2Ftrunk%2Fengine%2Ftest-data%2FModels%2FNinja[忍者表層]
*  link:http://jmonkeyengine.googlecode.com/svn/trunk/engine/town.zip[小鎮場景]
...
.  jMonkeyEngine 呼叫所有SimpleApplication 類別的simpleUpdate()方法讓你來附加他們.
.  jMonkeyEngine 呼叫所有控制的controlUpdate()方法讓你有辦法來增加他們.
.  jMonkeyEngine 呼叫主要 SimpleApplication 類別的simpleUpdate()方法.
