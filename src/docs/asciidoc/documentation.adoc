...
You are also very welcome to fix mistakes or spelling as well as unclear paragraphs using the "`Wiki`" menu "`Edit`" icon:fas fa-pencil-square[role="blue"] and "`Add`" icon:fas fa-plus-square[role="blue"] buttons. You have to be logged into GitHub to edit the wiki. You can learn more about editing and contributing under the <<wiki/#contribute#,Contribute>> heading.
