...
There are dozens of community-made libraries available to streamline your development journey. Here is a list of the most popular ones:
...
A more complete listing of community contributions can be found link:https://github.com/codex128/Awesome-JMonkeyEngine[here].
