...
[NOTE]
====
The SeaMonkey WaterFilter is ideal for oceans and lakes, and especially for under-water scenes. If you only need a small simple water surface, such as a water trough or a shallow fountain, the xref:effect/water.adoc[SimpleWaterProcessor] may already be all you need.
====
...
image::effect/water-post-muddy.png[water-post-muddy.png,width="220",height="172"]
